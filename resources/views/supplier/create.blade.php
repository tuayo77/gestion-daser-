      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Ajouter un fournisseur</h3>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="supplier_contact1" class ='form-control' placeholder = '' required="required" maxlength="14" minlength="7"/>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="supplier_contact2" class ='form-control' placeholder = '' maxlength="14" minlength="7"/>
                          </div>
                        </div>
