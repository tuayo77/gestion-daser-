...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Modifier les stocks</li>
  </ol>
</section>
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Modifier Stock / Produit</h3>
            ...
            <form class="form-horizontal create_stock" role="form" method="POST" action="{{ url('/stock/update/'.$stock_details->stock_id) }}">
                    ...
                    <div class="box-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label>Coût d'achat / Unité</label><br>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label>Coût d'achat / Unité</label>
                          ...
                          <div class="form-group">
                            ...
                            <option selected="" disabled="" value="">- Selectionner - </option>
                              ...
                              @if($stock_details->supplier_id == 0)
                                  <option value="0" selected="">- Plusieurs fournisseurs -</option>
                              @else
