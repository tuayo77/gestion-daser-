...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $messageType = 2;
            $message = "La création d'achat a échoué !";            
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $messageType = 1;
            $message = "les détails de l'Achat " .$purchase->purchase_name." on été  mis à jour avec succès!";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La mise à jour des achats a échoué !";
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            $messageType = 1;
            $message = "les détails de l'achat ".$purchase->purchase_name."  on été supprimés avec succès!";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La suppression de l'achat a échoué !";
        }
