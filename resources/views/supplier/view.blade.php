...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Afficher les fournisseurs</li>
  </ol>
</section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-header with-bsupplier">
            <h3 class="box-title">Afficher les fournisseurs</h3>
            ...
            <div class="row" style="width:99%;margin-left:5px">
                      <div class="col-xs-12">
                        <table id="table" class="table table-responsive" 
                            ...
                            <thead>
                            <tr>
                                <th data-field="id" data-align="center" data-sortable="true"> ID fournisseurs</th>
                                <th data-field="supplier_name" data-align="center" data-sortable="true">Nom</th>
                                ...
                                <th data-field="supplier_contact1" data-align="center" data-sortable="true">Mobile 1</th>
                                <th data-field="supplier_contact2" data-align="center" data-sortable="true"> Mobile 2</th>
                                <th data-field="balance" data-align="center" data-sortable="true">solde dû</th>
