...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Voir les Catégories de stock</li>
  </ol>
</section>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box-header with-bstock_category">
            <h3 class="box-title">Voir les Catégories de stock</h3>
            ...
            <div class="row" style="width:99%;margin-left:5px">
                      <div class="col-xs-12">
                        <table id="table" class="table table-responsive" 
                            ...
                            <thead>
                            <tr>
                                <th data-field="id" data-align="center" data-sortable="true"> ID Categorie</th>
                                <th data-field="category_name" data-align="center" data-sortable="true">Nom Categories </th>
                                
                                <th data-align="center" data-formatter="measuresFormatter"> Les mesures </th>

                                <th data-align="center" data-formatter="unitFormatter"> Unité </th>
