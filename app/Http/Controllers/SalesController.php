...
class SalesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        \App\Models\Transaction::create($transaction_details);                                      
            ...
            $messageType = 1;
            $message = "Ventes créées avec succès !";
        try {
            ...
            $messageType = 2;
            $message = "La création des ventes a échoué !";            
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $messageType = 1;
            $message = "Les details de La Vente ".$sales->sales_name."  on été Mis à jour avec succés !";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La mise à jour des ventes a échoué !";
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            $messageType = 1;
            $message = "les détails de La Vente ".$sales->sales_name." on été  supprimés avec succès !";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La suppression des ventes a échoué!";
        }
