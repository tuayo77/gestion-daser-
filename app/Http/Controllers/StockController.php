...
class StockController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      unset($request['measure_id'],$request['uom_id'],$request['value']);
        ...
        try {
            ...
            $messageType = 2;
            $message = "La création du stock a échoué!";            
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $messageType = 1;
            $message = "les details du Stock ".$stock->stock_name."  on été mise à jour !";
    ...
    public function destroy($id)
    {
        try {
            ...
            $messageType = 1;
            $message = "les details du Stock ".$stock->stock_name."  on été supprimé!";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La suppression des stocks a échoué !";
        }
