...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $messageType = 2;
            $message = "La création du fournisseur a échoué!";            
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $messageType = 1;
            $message = "Les details du fournisseur ".$supplier->supplier_name."  on été mise a jour!";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La mise à jour du fournisseur a échoué !";
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            $messageType = 1;
            $message = "les details du fournisseur ".$supplier->supplier_name."  on été supprimer !";
