...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Afficher les découvertes</li>
  </ol>
</section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-header with-bsales">
            <h3 class="box-title">Afficher les découvertes</h3>
                      ...
                      <div class="col-xs-12">
                        <table id="table" class="table table-responsive" 
                            ...
                            <tr>
                                ...
                                <th data-field="sales_id" data-align="center" data-sortable="true"> Id vente</th>
                                ...
                                <th data-field="subtotal" data-align="center" data-sortable="true">Prix d'achat</th>

                                <th data-field="payment" data-align="center" data-sortable="true">Paiement</th>

                                <th data-field="balance" data-align="center" data-sortable="true">Reste</th>

                                <th data-field="due" data-align="center" data-sortable="true">dete</th>
