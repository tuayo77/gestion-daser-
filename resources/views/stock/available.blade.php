...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Voir les stocks disponibile </li>
  </ol>
</section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-header with-bstock_category">
            <h3 class="box-title">Voir les stocks disponibile</h3>
                      ...
                      <div class="col-xs-12">
                        <table id="table" class="table table-responsive" 
                            ...
                            <tr>
                                ...
                                <th data-field="stock_name" data-align="center" data-sortable="true"> Type de Stock</th>
