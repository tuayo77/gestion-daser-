...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $messageType = 2;
            $message = "La création de catégorie a échoué !";            
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $messageType = 1;
            $message = "les détails de la Category ".$category->category_name."  sont mis à jour avec succès !";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La mise à jour de catégorie a échoué !";
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            $messageType = 1;
            $message = "La Categorie ".$category->category_name." détails supprimés avec succès !";

        } catch(\Illuminate\Database\QueryException $ex){  
            $messageType = 2;
            $message = "La suppression de catégorie a échoué!";
        }
